...
const WAVE_DATA := {
	...
	6: { 0: [{ "type": Types.EnemyType.ZOMBIE, "count": 6 }], 1: [{ "type": Types.EnemyType.ZOMBIE, "count": 4 }] },
	7: { 0: [{ "type": Types.EnemyType.SKELETON, "count": 5 }], 1: [{ "type": Types.EnemyType.ZOMBIE, "count": 5 }] },
	8: { 0: [{ "type": Types.EnemyType.SLIME, "count": 4 }], 1: [{ "type": Types.EnemyType.SLIME, "count": 4 }] },
	...
	11: { 0: [{ "type": Types.EnemyType.SKELETON, "count": 8 }], 1: [{ "type": Types.EnemyType.SLIME, "count": 5 }] },
	12: { 0: [{ "type": Types.EnemyType.ZOMBIE, "count": 10 }], 1: [{ "type": Types.EnemyType.SKELETON, "count": 8 }] },
	13: { 0: [{ "type": Types.EnemyType.ZOMBIE, "count": 6 }], 1: [{ "type": Types.EnemyType.ZOMBIE, "count": 6 }], 2: [{ "type": Types.EnemyType.ZOMBIE, "count": 4 }] },
	14: { 0: [{ "type": Types.EnemyType.SKELETON, "count": 6 }], 1: [{ "type": Types.EnemyType.SLIME, "count": 4 }], 2: [{ "type": Types.EnemyType.ZOMBIE, "count": 6 }] },
	15: { 0: [{ "type": Types.EnemyType.SLIME, "count": 6 }], 1: [{ "type": Types.EnemyType.SKELETON, "count": 6 }], 2: [{ "type": Types.EnemyType.SKELETON, "count": 4 }] },
	16: { 0: [{ "type": Types.EnemyType.ZOMBIE, "count": 10 }], 1: [{ "type": Types.EnemyType.ZOMBIE, "count": 10 }], 2: [{ "type": Types.EnemyType.SLIME, "count": 5 }] },
