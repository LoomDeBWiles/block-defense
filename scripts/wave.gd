...
const WAVE_DATA := {
	...
	8: { 0: [{ "type": Types.EnemyType.SLIME, "count": 4 }, { "type": Types.EnemyType.IRON_GOLEM, "count": 2 }], 1: [{ "type": Types.EnemyType.SLIME, "count": 4 }] },
	9: { 0: [{ "type": Types.EnemyType.ZOMBIE, "count": 6 }, { "type": Types.EnemyType.SKELETON, "count": 4 }], 1: [{ "type": Types.EnemyType.ZOMBIE, "count": 6 }] },
	...
	11: { 0: [{ "type": Types.EnemyType.SKELETON, "count": 8 }, { "type": Types.EnemyType.IRON_GOLEM, "count": 2 }], 1: [{ "type": Types.EnemyType.SLIME, "count": 5 }] },
	12: { 0: [{ "type": Types.EnemyType.ZOMBIE, "count": 10 }], 1: [{ "type": Types.EnemyType.SKELETON, "count": 8 }, { "type": Types.EnemyType.IRON_GOLEM, "count": 2 }] },
	13: { 0: [{ "type": Types.EnemyType.ZOMBIE, "count": 6 }, { "type": Types.EnemyType.IRON_GOLEM, "count": 1 }], 1: [{ "type": Types.EnemyType.ZOMBIE, "count": 6 }], 2: [{ "type": Types.EnemyType.ZOMBIE, "count": 4 }] },
	14: { 0: [{ "type": Types.EnemyType.SKELETON, "count": 6 }], 1: [{ "type": Types.EnemyType.SLIME, "count": 4 }, { "type": Types.EnemyType.IRON_GOLEM, "count": 2 }], 2: [{ "type": Types.EnemyType.ZOMBIE, "count": 6 }] },
	15: { 0: [{ "type": Types.EnemyType.SLIME, "count": 6 }], 1: [{ "type": Types.EnemyType.SKELETON, "count": 6 }], 2: [{ "type": Types.EnemyType.SKELETON, "count": 4 }, { "type": Types.EnemyType.IRON_GOLEM, "count": 2 }] },
	16: { 0: [{ "type": Types.EnemyType.ZOMBIE, "count": 10 }, { "type": Types.EnemyType.IRON_GOLEM, "count": 3 }], 1: [{ "type": Types.EnemyType.ZOMBIE, "count": 10 }], 2: [{ "type": Types.EnemyType.SLIME, "count": 5 }] },
	17: { 0: [{ "type": Types.EnemyType.SKELETON, "count": 10 }], 1: [{ "type": Types.EnemyType.SLIME, "count": 6 }, { "type": Types.EnemyType.IRON_GOLEM, "count": 3 }], 2: [{ "type": Types.EnemyType.ZOMBIE, "count": 8 }] },
	18: { 0: [{ "type": Types.EnemyType.SLIME, "count": 8 }], 1: [{ "type": Types.EnemyType.SKELETON, "count": 10 }], 2: [{ "type": Types.EnemyType.SKELETON, "count": 6 }, { "type": Types.EnemyType.IRON_GOLEM, "count": 3 }] },
	19: { 0: [{ "type": Types.EnemyType.ZOMBIE, "count": 12 }, { "type": Types.EnemyType.SLIME, "count": 4 }, { "type": Types.EnemyType.IRON_GOLEM, "count": 2 }], 1: [{ "type": Types.EnemyType.SKELETON, "count": 10 }], 2: [{ "type": Types.EnemyType.SLIME, "count": 6 }] },
...
func _spawn_wave() -> void:
	_spawning = true
	var wave_data: Dictionary = WAVE_DATA.get(GameState.wave, {})
	var interval := _get_spawn_interval()
	var active_spawns := get_active_spawns(GameState.wave)
